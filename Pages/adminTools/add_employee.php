...
<form action="php_script/insert_employee.php" method="post">
      <input type="hidden" name="id" />
        <div class="w3-row w3-container">
          <div class="w3-col m4 w3-padding-small">
            <label> Name :</label>
            <input class="w3-input w3-border" type="text" name="nameEmployee" required >  
          </div>
        </div>
        ...
        <div class="w3-row w3-container">
          <div class="w3-col m4 w3-padding-small">
            ...
            <input class="w3-input w3-border" type="text" name="staff_ID" > 
          </div>
        </div>
        ...
        <div class="w3-row w3-container">
          <div class="w3-col m4 w3-padding-small">
            ...
            <input class="w3-input w3-border" type="text" name="assigned_area" placeholder="District/Location"> 
          </div>
        </div>
        ...
        <div class="w3-row w3-container" style="padding-top: 32px">
          <div class="w3-col m2 w3-padding-small">
            <input class="w3-button w3-round w3-theme w3-hover-aqua w3-padding-large w3-block" type="submit" name="Add" value="Add">
          </div>   
  </form>
        <div class="w3-col m2 w3-padding-small">
